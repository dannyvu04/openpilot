...
_A_LAT_REG_MAX = 4.  # Maximum lateral acceleration
...
_TURNING_ACC_V = [0.5, 0., -0.4, ACCEL_MIN]  # acc value
_TURNING_ACC_BP = [1.5, 2.3, 2.9, 3.6]  # absolute value of current lat acc
